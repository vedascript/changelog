-- CreateEnum
CREATE TYPE "UPDATE_STATUS" AS ENUM ('IN_PROGRESS', 'DEPRECATED', 'COMPLETED');
...
-- AddForeignKey
ALTER TABLE "Update" ADD CONSTRAINT "Update_belongsToProductId_fkey" FOREIGN KEY ("belongsToProductId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
